    ...
    generatePackingListHTML(groupedOrders) {
        ...
        orders.forEach((order, orderIndex) => {
            ...
            <div class="page">
                <!-- Header Section -->
                <div class="header">
                    ${logoBase64_1 ? `<img src="data:image/png;base64,${logoBase64_1}" class="logo-img" alt="Territorial Seed Company">` : '<div class="company-title">Territorial Seed Company</div>'}
                    <div class="company-address">P. O. Box 158 - Cottage Grove, OR 97424 - 541-942-9547</div>
                </div>

                <!-- Top Right Info -->
                <div class="top-right-info">
                    <div class="expected-ship-date">Expected Ship Date</div>
                ...
                <div class="from-section">
                    ...
                    <div class="from-content">
                        <div class="from-logo">
                            ${logoBase64_3 ? `<img src="data:image/png;base64,${logoBase64_3}" class="from-logo-img" alt="Territorial Seed Company">` : '<div style="font-size: 14px; font-weight: bold;">Territorial Seed Company</div>'}
                        </div>
                        <div class="from-address">P. O. Box 158 - Cottage Grove, OR 97424 - 541-942-9547</div>
                        <div class="ship-to-line">
                ...
                <div class="center-content">
                    ${logoBase64_3 ? `<img src="data:image/png;base64,${logoBase64_3}" class="center-logo-img" alt="Territorial Seed Company">` : '<div class="center-title">Territorial Seed Company</div>'}
                    <div class="center-address">P. O. Box 158 - Cottage Grove, OR 97424 - 541-942-9547</div>
                    
                    <div class="center-customer">
                        <div class="center-customer-name">JC</div>
                        <div>217 Lewiston Rd</div>
                        <div>MIDDLEPORT, NY 14105</div>
                    </div>
