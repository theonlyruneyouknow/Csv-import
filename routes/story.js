...
// We don't need ensureAuthenticated here since it's applied at the app level
...
// Projects Management
router.get('/projects', ensureStoryAccess, async (req, res) => {
    try {
...
// Create Project
router.post('/projects', ensureStoryAccess, async (req, res) => {
    try {
        const projectData = {
            ...req.body,
            author: req.user._id
...
// Update Project
router.put('/projects/:id', ensureStoryAccess, async (req, res) => {
    try {
        const project = await Project.findOne({ 
            _id: req.params.id, 
            author: req.user._id 
...
// Delete Project
router.delete('/projects/:id', ensureStoryAccess, async (req, res) => {
    try {
        const project = await Project.findOne({ 
            _id: req.params.id, 
            author: req.user._id 
...
router.post('/stories', ensureStoryAccess, async (req, res) => {
    try {
...
router.get('/stories/:id', ensureStoryAccess, async (req, res) => {
    try {
        const story = await Story.findOne({
            _id: req.params.id,
            author: req.user._id
...
// Delete Story
router.delete('/stories/:id', ensureStoryAccess, async (req, res) => {
    try {
        const story = await Story.findOne({ 
            _id: req.params.id, 
            author: req.user._id 
...
// Timeline Management
router.get('/timelines/:projectId', ensureStoryAccess, async (req, res) => {
    try {
        const project = await Project.findOne({
...
// Create Timeline
router.post('/timelines', ensureStoryAccess, async (req, res) => {
    try {
...
// Update Timeline
router.put('/timelines/:id', ensureStoryAccess, async (req, res) => {
    try {
...
// Add Timeline Event
router.post('/timelines/:id/events', ensureStoryAccess, async (req, res) => {
    try {
        const timeline = await Timeline.findOne({ 
            _id: req.params.id, 
            author: req.user._id 
...
router.get('/characters/:projectId', ensureStoryAccess, async (req, res) => {
    try {
        const project = await Project.findOne({
            _id: req.params.projectId,
            $or: [
...
// Create Character
router.post('/characters', ensureStoryAccess, async (req, res) => {
    try {
...
// Update Character
router.put('/characters/:id', ensureStoryAccess, async (req, res) => {
    try {
...
router.get('/characters/detail/:id', ensureStoryAccess, async (req, res) => {
    try {
        const character = await Character.findOne({
            _id: req.params.id,
            $or: [
